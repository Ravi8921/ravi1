...
project/booksManagement project with node.js, express.js, mongoDb & AWS S3
...
## Books API
### POST /books
- Add one more feild of coverphoto use aws S3 for implementation pass file of photo from the postman to the server.
